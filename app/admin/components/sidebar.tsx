...
const menu = [
    ...
    { href: "/admin/products", name: "Produk", icon: Coffee },
    { href: "/admin/transactions", name: "Transaksi", icon: FileChartColumn },
    { href: "/admin/materials", name: "Bahan Baku", icon: Package },
    { href: "/admin/employees", name: "Karyawan", icon: User },
];
...
export default function Sidebar() {
    ...
    return (
        <nav className="flex flex-col gap-4 p-6 w-2/7 md:w-1/4 lg:w-2/9 h-full sidebar">
